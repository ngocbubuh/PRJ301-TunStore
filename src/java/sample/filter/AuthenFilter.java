 ...
 * @author 1005h
 */
@WebFilter(filterName = "AuthenFilter", urlPatterns = {"/MainController"})
public class AuthenFilter implements Filter {
    ...
    public AuthenFilter() {
        ...
        NON_AUTHEN_RESOURCE.add("404.html");
        NON_AUTHEN_RESOURCE.add("checkOut.jsp");
        NON_AUTHEN_RESOURCE.add("create.html");
        NON_AUTHEN_RESOURCE.add("create.jsp");
        NON_AUTHEN_RESOURCE.add("login.html");
        NON_AUTHEN_RESOURCE.add("login.jsp");
        NON_AUTHEN_RESOURCE.add("paymentResult.jsp");
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            if (NON_AUTHEN_RESOURCE.contains(resource)) {
